# *** Принцип полиморфизма, Полиморфизм
...
# Полиморфизм функций
res = len("python")  # количество символов 
res = len([10, 20, 30]) # список с тремя элементами 

# print(res)

# Полиморфизм методов
class A:
    # атрибут (ствойство) определенное без конструктора
    attr_1 = 100
    def m1(self, arg):
...
# Полиморфизм с "Магическими" методами (методами перегрущки операторов)
